...
*   **框架**：基于 React 18，利用其强大的组件化能力构建复杂的 UI。
*   **动画引擎**：使用 `framer-motion` 实现顺滑的路线切换和元素动效，模拟“太极变幻”的流体感。
*   **样式体系**：采用 Tailwind CSS。项目中定义了一套自创的“玄学工业风”配色（墨黑、朱砂红、宣纸白），并辅以毛玻璃效果和细腻的边框纹理（Lattice corners）。
